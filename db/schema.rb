...
ActiveRecord::Schema.define(version: 2020_02_20_225841) do
  ...
  create_table "bulk_meta_cells", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "row_id"
    t.string "name"
    t.string "value_url"
    t.integer "status"
    ...
    t.datetime "updated_at", null: false
    t.text "value"
    t.index ["row_id"], name: "index_bulk_meta_cells_on_row_id"
  end

  create_table "bulk_meta_ingests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
    t.string "filename"
    t.string "work_type"
    t.string "status"
    ...
    t.string "ignore"
    t.index ["user_id"], name: "index_bulk_meta_ingests_on_user_id"
  end

  create_table "bulk_meta_logs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "ingest_id"
    t.integer "row_id"
    t.integer "cell_id"
    t.string "type"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cell_id"], name: "index_bulk_meta_logs_on_cell_id"
    t.index ["ingest_id"], name: "index_bulk_meta_logs_on_ingest_id"
    t.index ["row_id"], name: "index_bulk_meta_logs_on_row_id"
  end

  create_table "bulk_meta_relationships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.integer "row_id"
    t.string "status"
    t.index ["row_id"], name: "fk_rails_e0a67ffd2b"
  end

  create_table "bulk_meta_rows", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "ingest_id"
    t.string "status"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "collection_branding_infos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "collection_type_participants", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "domain_terms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "model"
    t.string "term"
    t.index ["model", "term"], name: "terms_by_model_and_term"
  end

  create_table "domain_terms_local_authorities", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "hyrax_collection_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.string "machine_id"
  ...
  create_table "ld_buffers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "url"
    t.string "label"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "local_authorities", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
  end

  create_table "local_authority_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "local_authority_id"
    t.string "label"
    t.string "uri"
  ...
  create_table "sipity_claims", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "sipity_workflow_states_id"
    t.string "work_id"
    t.index ["sipity_workflow_states_id"], name: "index_sipity_claims_on_sipity_workflow_states_id"
    t.index ["user_id"], name: "index_sipity_claims_on_user_id"
  end
  ...
  create_table "subject_local_authority_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "label"
    t.string "lowerLabel"
    t.string "url"
