...
#  mount Riiif::Engine => 'images', as: :riiif if Hyrax.config.iiif_image_server?
  ...
  put '/dashboard/workflow_actions/update(.:format)', to: 'ucsc/workflow_actions#update'
  patch '/dashboard/workflow_actions/update(.:format)', to: 'ucsc/workflow_actions#update'
