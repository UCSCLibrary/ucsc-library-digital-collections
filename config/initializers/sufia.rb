Sufia.config do |config|
  ...
  config.google_analytics_id = 'UA-79152041-1'

  # Specify a date you wish to start collecting Google Analytic statistics for.
  config.analytic_start_date = DateTime.new(2016,8,24)
  ...
  #config.derivatives_path = File.join('avalon2sufia','derivatives')
  config.derivatives_path = '/avalon2sufia/derivatives'
#  config.derivatives_path = File.join(Rails.root, 'tmp', 'derivative-test')
