...
if (typeof springSpace.la.widget_6282 == 'undefined') {
    ...
    springSpace.la.widget_6282 = function() {
        ...
        this.css_url = 'https://api2.libanswers.com/css2.31.2/LibAnswers_widget_feedback.css';
        ...
        this.question = {};
        this.chatwidget = {};
        this.cascadeServer = "https:\/\/cascade2.libchat.com";
        ...
        this.getFAQ = function(faqid) {
            springSpace.jq.get(
                ...
                function(d) {
                    var output = springSpace.mustache.render(that.faq_template, d.data.faqs[0]);
...
if (typeof springSpace.la.fbwidget_loader == 'undefined') {
    springSpace.la.fbwidget_loader = function(widget_id) {
        ...
        this.loadJquery = function(){
            ...
            script_tag.setAttribute("src", "https://v2.libanswers.com/js2.31.2/jquery.min.js");
