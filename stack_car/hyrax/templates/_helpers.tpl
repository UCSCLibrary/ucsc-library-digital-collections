...
{{- if .Chart.AppVersion }}
hyrax.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
hyrax.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end }}
...
hyrax.kubernetes.io/name: {{ include "hyrax.name" . }}
hyrax.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
{{- define "hyrax.cantaloupe.name" -}}
{{- include "hyrax.fullname" . -}}-cantaloupe
{{- end -}}
{{- define "hyrax.cantaloupe-env.name" -}}
{{- include "hyrax.fullname" . -}}-cantaloupe-env
{{- end -}}
...
{{- if .Values.mariadb.enabled }}
{{- .Values.mariadb.auth.name }}
{{- else }}
{{- .Values.externalMariadb.database | default ( include "hyrax.fullname" . ) }}
{{- end }}
{{- end -}}
...
{{- else }}
{{- .Values.externalMariadb.username | default "mysql" }}
{{- end }}
{{- end -}}
...
{{- else }}
{{- .Values.externalMariadb.password }}
{{- end }}
{{- end -}}
