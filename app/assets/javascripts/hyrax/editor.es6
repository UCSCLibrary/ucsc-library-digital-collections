...
export default class {
  ...
  constructor(element) {
    ...
    this.multiControlledVocabularies()
    this.sharingTab()
  ...
  // initialize any multiple controlled vocabulary widgets
  multiControlledVocabularies() {
    var controlled_field = this.element.find('.multi_controlled_vocabulary.form-group')
    console.log('multicontrolled field name: ' + controlled_field.data("field-name"))
